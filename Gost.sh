...
echo "═════════════════════════════════════════MENU══════════════════════════════════════════"
options=($'\e[36m1. \e[36m Gost Tunnel By IP4'
         $'\e[96m2. \e[96m Gost Tunnel By IP6'
         $'\e[36m3. \e[36m Gost Status'
         $'\e[96m4. \e[96m Update Script'
         $'\e[36m5. \e[36m Add New IP'
         $'\e[96m6. \e[96m Auto Restart Gost'
         $'\e[36m7. \e[36m Auto Clear Cache'
         $'\e[96m8. \e[96m Install BBR'
         $'\e[36m9. \e[36m Uninstall'
         $'\e[96m0. \e[96m Exit')
printf "%s\n" "${options[@]}"
echo "══════════════════════════════════════════════════════════════════════════════════════"
...
if [ "$choice" -eq 1 ] || [ "$choice" -eq 2 ]; then
    if [ "$choice" -eq 1 ]; then
        read -p $'\e[97mPlease enter the Kharej IPv4: \e[0m' destination_ip
    elif [ "$choice" -eq 2 ]; then
        read -p $'\e[97mPlease enter the Kharej IPv6: \e[0m' destination_ip
    fi
...
systemctl enable sysctl-custom
    ...
    echo $'\e[36m1. \e[0mGost version 3.0.0 (latest)'
...
wget -O /etc/gost/install.sh https://raw.githubusercontent.com/iPmartNetwork/Gost/main/Gost.sh
...
# If option 6 is selected
    ...
    echo $'\e[32mChoose Gost version:\e[0m'
    echo $'\e[36m1. \e[0mGost version (latest)'
...
if [ "$choice" -eq 9 ]; then
    ...
    wget -N --no-check-certificate https://github.com/ipmartnetwork/BBR/raw/main/BBR.sh && \
    chmod +x bbr.sh && \
    bash bbr.sh
    bash "$0"
